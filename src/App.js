  ...
  return (
    <div className="App" id="App">
      ...
      <Box
        ...
        p="I’re a **front-end developer** with a passion for creating engaging, user-friendly websites. Beyond coding, I’re also excited about **music**, especially playing the **guitar** and **keyboard**, which adds a creative flair to Ir life. When I’re not coding or jamming, I love to **play sports**, embracing both physical activity and teamwork. It’s clear I have a diverse set of interests that fuel Ir creativity and drive for growth—whether it’s through building websites, making music, or staying active with sports. Keep pushing Ir boundaries in all these areas!"
        height="400px"
        width="300px"
      ...
      <div class="details">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <img src={i} class="insta" />
        </a>
        <a href="mailto:goyal.aryan@gmail.com">
          <img class="gmail" src={m} />
        </a>
      </div>
    </div>
  );
